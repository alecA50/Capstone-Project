...
import kotlinx.android.synthetic.main.activity_user_model_faculty_update.*
import org.json.JSONException
import org.json.JSONObject

class User_Model_Faculty_Update : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_user_model_faculty_update)
        ...
        registerButton!!.setOnClickListener {
            ...
            if (user == "") {
                ...
                val pd = ProgressDialog(this@User_Model_Faculty_Update)
                ...
                val request = StringRequest(
                    ...
                    { s ->
                        ...
                        if (s == "null") {
                            ...
                            Toast.makeText(
                                this@User_Model_Faculty_Update,
                                "registration or updated successful",
                                Toast.LENGTH_LONG
                            ).show()
                        } else {
                            try {
                ...
                val rQueue = Volley.newRequestQueue(this@User_Model_Faculty_Update)
                rQueue.add(request)
            }
        }
        returnButton.setOnClickListener {
            ...
            startActivity(Intent(this@User_Model_Faculty_Update, ProfilePage::class.java))
            finish()
